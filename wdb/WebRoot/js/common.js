var version;
if (typeof(aixuedai) === 'undefined') {
    var d = new Date();
    version = d.getYear() + d.getMonth() + d.getDate() + d.getHours() + d.getMinutes();
}
var f = function () {};
if (!window.console) {
    window.console = {
...
require.config({
    baseUrl: 'http://www-static.aixuedai.com/js',
    //urlArgs: "version=9997",// + version ||　aixuedai.versions,//20150814001
    paths: {
        jquery: 'vendor/jquery-1.7.1.min',
        cookie: 'vendor/jquery.cookie.min',
        jqtools: 'vendor/jquery.tools.min',
        overlay: 'vendor/jquery.tools.overlay',
        lazyload: 'vendor/jquery.lazyload',
        tmpl: 'vendor/tmpl.min',
        json: 'vendor/json',
        jqform: 'vendor/jquery.form',
        qrcode:'vendor/jquery.qrcode',
        rotate:'vendor/rotate'
    },
    shim: {
        'jqtools': ['jquery'],
        'lazyload': ['jquery'],
...
define("jqtools", ["jquery"], function(){});
...
define("overlay", ["jquery","jqtools"], function(){});
...
datalazyload = (function($){
	...
	var config = {
		mod : 'manul', //分为auto和manul
		IMG_SRC_DATA : 'original',
		AREA_DATA_CLS : 'J_lazyload'
	};
...
!function(a){"use strict";var b=function(a,c){var d=/[^\w\-\.:]/.test(a)?new Function(b.arg+",tmpl","var _e=tmpl.encode"+b.helper+",_s='"+a.replace(b.regexp,b.func)+"';return _s;"):b.cache[a]=b.cache[a]||b(b.load(a));return c?d(c,b):function(a){return d(a,b)}};b.cache={},b.load=function(a){return document.getElementById(a).innerHTML},b.regexp=/([\s'\\])(?!(?:[^{]|\{(?!%))*%\})|(?:\{%(=|#)([\s\S]+?)%\})|(\{%)|(%\})/g,b.func=function(a,b,c,d,e,f){return b?{"\n":"\\n","\r":"\\r","	":"\\t"," ":" "}[b]||"\\"+b:c?"="===c?"'+_e("+d+")+'":"'+("+d+"==null?'':"+d+")+'":e?"';":f?"_s+='":void 0},b.encReg=/[<>&"'\x00]/g,b.encMap={"<":"&lt;",">":"&gt;","&":"&amp;",'"':"&quot;","'":"&#39;"},b.encode=function(a){return(null==a?"":""+a).replace(b.encReg,function(a){return b.encMap[a]||""})},b.arg="o",b.helper=",print=function(s,e){_s+=e?(s==null?'':s):_e(s);},include=function(s,d){_s+=tmpl(s,d);}","function"==typeof define&&define.amd?define('tmpl',[],function(){return b}):a.tmpl=b}(this);
