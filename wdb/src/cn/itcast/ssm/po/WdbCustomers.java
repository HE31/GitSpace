...
public class WdbCustomers {
    ...
    public void setCustparentname(String custparentname) {
        this.custparentname = custparentname == null ? null : custparentname.trim();
    }
    ...
    public void setCustparentphonenum(String custparentphonenum) {
        this.custparentphonenum = custparentphonenum == null ? null : custparentphonenum.trim();
    }
    ...
    public void setCustuniversity(String custuniversity) {
        this.custuniversity = custuniversity == null ? null : custuniversity.trim();
    }
    ...
    public void setCustinuniversity(String custinuniversity) {
        this.custinuniversity = custinuniversity == null ? null : custinuniversity.trim();
    }
    ...
    public void setCusthead(String custhead) {
        this.custhead = custhead == null ? null : custhead.trim();
    }
